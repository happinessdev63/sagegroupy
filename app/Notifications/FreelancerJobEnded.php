...
class FreelancerJobEnded extends Notification
{
    use Queueable;
    ...
    public function toMail( $notifiable )
    {
        return ( new SageMailMessage )
            ...
            ->line( "Your job has now been marked as completed / closed by the client. Keep up the good work!" )
            ->line( "You can view the clients feedback and rating on the job details page." )
            ->line( "Reason for ending job: " )
            ->line( $this->job->end_reason )
