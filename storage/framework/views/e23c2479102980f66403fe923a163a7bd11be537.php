                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <form class="text-center" action="/prelaunch" method="post">
                                <input type="hidden" name="referrer" value="<?php echo e(Cookie::get('referrer','No Referrer')); ?>" />
...
<?php echo $__env->make('layouts.lander', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>