...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(Auth::user()->is_freelancer): ?>
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12 padding-bottom-10 ">
                <div class="bg-white border-radius-5 margin-bottom-20 md-whiteframe-3dp padding-20" v-cloak>
                    <span class="font-size-20 font-weight-400"><?php echo e($user->name); ?></span>
                    <md-progress :md-progress="<?php echo e($user->percent_complete_score); ?>" class="margin-bottom-5">
                    </md-progress>
                    <span class="text-muted margin-top-5 tour-profile-complete">Your profile is <?php echo e($user->percent_complete_score); ?>% complete.</span>

                    <div v-if="shared.user.percent_complete_score < 100" class="margin-top-20">
                        <ul class="list-group margin-top-5">
                            <?php if($user->avatar == '/img/avatar.jpg'): ?>
                            <li class="list-group-item">
                                ...
                                <a href="/profile/edit/<?php echo e($user->id); ?>" class="pull-right link-primary">Take Me There</a>
                                <div class="clearfix"></div>
                            </li>
                            <?php endif; ?>

                            <?php if(strlen($user->bio) < 100): ?>
                            <li class="list-group-item">
                                <md-icon class="pull-left text-muted margin-right-10">assignment_late</md-icon>
                            ...
                            <?php if($user->tagline == 'No tagline set.'): ?>
                                <li class="list-group-item">
                                    <md-icon class="pull-left text-muted margin-right-10">assignment_late</md-icon>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12  padding-bottom-20" id='notifications'>
                <sage-notifications  :owner="<?php echo e($user->id); ?>" v-cloak ref="notifications"></sage-notifications>
            </div>
        </div>
        <div class="row">
    ...
    <?php if((Auth::user()->is_client && !Auth::user()->is_freelancer) || Auth::user()->isAdmin): ?>
        <div class="row">
            <div class="col-lg-12 col-sm-12 padding-bottom-10 ">
            <div class="bg-white border-radius-5 margin-bottom-20 md-whiteframe-3dp padding-20" v-cloak>
                <span class="font-size-20 font-weight-400"><?php echo e($user->name); ?></span>
                ...
                <div v-if="shared.user.percent_complete_score < 100" class="margin-top-20">
                    <ul class="list-group margin-top-5">
                        ...
                        <?php if($user->clientJobs->count() == 0): ?>
                            <li class="list-group-item">
                                <md-icon class="pull-left text-muted margin-right-10">assignment_late</md-icon>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12   padding-bottom-20">
                <sage-notifications id='notifications' :owner="<?php echo e($user->id); ?>" v-cloak ref="notifications"></sage-notifications>
            </div>
        </div>
    <?php endif; ?>

    <?php if(Auth::user()->is_client && !Auth::user()->is_freelancer): ?>
        <div class="row">
            <div class="col-lg-12 text-center padding-bottom-20">
                <!-- Dashboard Responsive -->
                <ins class="adsbygoogle"
    ...
    <?php echo $__env->make('modals.reminderModals', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
