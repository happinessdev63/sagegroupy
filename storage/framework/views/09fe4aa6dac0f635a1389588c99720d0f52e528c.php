...
<?php if($activeModal ==  'agenciesReminder'): ?>
...
<?php if($activeModal ==  'profileReminder'): ?>
<sage-modal :delay="3300" title="Complete Your Profile" :show-logo="true" name="profileReminderModal" v-cloak>
    ...
    <div class="text-center">
        <md-button href="/profile/edit/<?php echo e(\Auth::user()->id); ?>" class="md-primary md-raised md-adj-width">
            Edit My Profile
        </md-button>
    </div>
...
<?php if($activeModal ==  'referencesReminder'): ?>
...
<!-- Jobs modal -->
<?php if($activeModal ==  'jobsReminder'): ?>
