...
<div class="row">
    <div class="col-lg-12 col-sm-12 padding-bottom-20 tour-agencies" id='search_option'>
      <md-whiteframe md-elevation="3" class="padding-4 bg-white">
        <md-tabs>
          <md-tab id="freelancer" md-label="Freelancer" md-icon="perm_contact_calendar" :md-active = "'<?php echo e($role); ?>' === 'freelancer'">
            <div>
                <sage-freelancer-list ></sage-freelancer-list>
            </div>
          </md-tab>
          <md-tab id="job" md-label="Job" md-icon="work" :md-active="'<?php echo e($role); ?>' === 'job'">
            <div>
