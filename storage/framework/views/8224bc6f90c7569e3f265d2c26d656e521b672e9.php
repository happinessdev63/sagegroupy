...
$style = [
    ...
    'email-masthead' => 'padding: 25px 0; text-align: center; border-bottom: 8px solid #25b473;',
                    ...
                    <tr>
                        <td style="<?php echo e($style['email-masthead']); ?>">
                            <a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">
                                <img src="<?php echo e(url("/img/logo_xs.png")); ?>" width="161" height="80"/>
                            </a>
                        </td>
                    </tr>
                                    ...
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <?php $__currentLoopData = $introLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p style="<?php echo e($style['paragraph']); ?>">
                                                <?php echo nl2br( strip_tags( $line, "<br><p><b><em><i><strong><ul><li>" ) ); ?>
                                        ...
                                        <?php if(isset($list) && count($list) > 0): ?>
                                            <?php if($list['title']): ?>
                                             ...
                                             <?php $__currentLoopData = $list['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <li style="<?php echo e($style['paragraph']); ?>"><?php echo e($item); ?></li>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             </ul>
                                        <?php endif; ?>
