    ...
    <html lang="en">
        ...
        <?php $__env->startSection('meta'); ?>
            <!-- META -->
                ...
                <meta property="og:image" content="<?php echo e(env("APP_URL")); ?>/img/icon_xxs.png"/>
                <meta property="twitter:image" content="<?php echo e(env("APP_URL")); ?>/img/icon_xxs.png"/>
            <?php echo $__env->yieldSection(); ?>
...
&noscript=1"/>
        ...
        <?php $__env->startSection('body'); ?>
            <body class="bg-white <?php if(Auth::user()): ?> site-menubar-unfold <?php endif; ?>">
                <?php echo $__env->yieldSection(); ?>
                <div id="app">
                    ...
                    <?php $__env->startSection('nav'); ?>
                        ...
                        <div class="site-menubar">
                                    ...
                                    <div>
                                        <ul class="site-menu">
                                            ...
                                            <li class="site-menu-item tour-edit-profile" :class="getNavClass('editProfile')">
                                                <a class="animsition-link" href="<?php echo e(\Auth::user()->profileEditLink); ?>" >
                                        ...
                                        <ul class="site-menu">
                                            ...
                                            <li class="site-menu-item" :class="getNavClass('viewJobs')">
                                                <a class="animsition-link" href="/userJobs">
                                                    ...
                                                    <span class="label label-primary pull-right margin-top-10"><?php echo e(Auth::user()->freelancerJobs->count()); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                                        <?php endif; ?>
                                        ...
                                        <ul class="site-menu">
                                            ...
                                            <li class="site-menu-item" :class="getNavClass('viewAgencies')">
                                                <a class="animsition-link" href="/userAgencies" >
                                                    ...
                                                    <span class="label label-primary pull-right margin-top-10"><?php echo e(Auth::user()->agencies->count() + Auth::user()->ownedAgencies->count()); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                                        <?php endif; ?>
                                            ...
                                            <ul class="site-menu">
                                                ...
                                                <li class="site-menu-item" :class="getNavClass('viewJobs')">
                                                    <a class="animsition-link" href="/userJobs" >
                                                        <i class="md-icon material-icons site-menu-icon md-theme-default">assignment</i>
                                                        <span class="site-menu-title">Your Jobs</span>
                                                        <span class="label label-primary pull-right margin-top-10"><?php echo e(Auth::user()->clientJobs->count()); ?></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        <?php endif; ?>
                            ...
                            <div class="site-menubar-footer">
                                <a href="<?php echo e(\Auth::user()->profileEditLink); ?>" class="fold-show" data-placement="top" data-toggle="tooltip"
                    ...
                    <?php if(Auth::user() && Auth::user()->id): ?>
                        <sage-chat :owner="<?php echo e(Auth::user()->id); ?>"></sage-chat>
                    <?php endif; ?>

                    <div class="<?php echo e(isset($contentClass) ? $contentClass : 'content'); ?>">
                        <?php $__env->startSection('content'); ?>
                        <?php echo $__env->yieldSection(); ?>

                        <?php $__env->startSection('inside-footer'); ?>
                        <?php echo $__env->yieldSection(); ?>
                    </div>
                    ...
                    <?php if(Auth::user() && Auth::user()->isAdmin()): ?>
                        <sage-admin-bulk-notify :owner="<?php echo e(Auth::user()->id); ?>"></sage-admin-bulk-notify>
                    <?php endif; ?>
