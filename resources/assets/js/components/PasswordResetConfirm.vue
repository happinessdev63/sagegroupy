...
<template>
    ...
    <form novalidate @submit.stop.prevent="submit">
        ...
        <md-button v-if="!state.loggingIn" @click="login()" class="md-raised md-primary">Reset Password</md-button>
        ...
        methods: {
            login: function () {
                ...
                this.$http.post('/password/reset', this.form).then((response) => {
                    ...
                    this.$root.showNotification("Your password has been reset. You can now login with your new password.");
                }, (response) => {
                    console.log(response);
                    this.state.loggingIn = false;
