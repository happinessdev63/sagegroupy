    ...
    <div class="vicp-wrap">
        ...
        <div class="vicp-step1" v-show="step == 1">
            ...
            <div class="text-center margin-top-5">
                <span class="text-primary" v-show="loading !== 1">{{ lang.hint }}</span>
    ...
    data() {
        let that = this,
            ...
            langBag = {
                ...
                en: {
                    hint: 'Click or drag your image here to upload.',
                    loading: 'Uploading……',
                    noSupported: 'Your browser is not supported, please use the latest version of Chrome or Firefox.',
                    ...
                    error: {
                        onlyImg: 'Only image files are accepted.',
                        outOfSize: 'Image exceeds the maximum size: ',
                        lowestPx: 'The image is too small, it should be at least '
                    }
                }
            },
