        ...
        mounted () {
            ...
            if (!this.useCustomDropzoneOptions) {
                this.dropzone = new Dropzone(element, {
                    ...
                    dictDefaultMessage: this.cloudIcon + '<br>Click here or drag and drop files to upload.<br/>You can edit your files below when they are done uploading.',
