...
<template>
    ...
    <form novalidate @submit.stop.prevent="submit">
        ...
        <md-button v-if="!state.loggingIn" @click="login()" class="md-raised md-primary">Send Password Reset Link</md-button>
        ...
        methods: {
            login: function () {
                ...
                this.$http.post('/password/email', this.form).then((response) => {
                    ...
                    this.$root.showNotification("A password reset link has been sent to " + this.form.email);
                }, (response) => {
                    console.log(response);
                    this.state.loggingIn = false;
